...
public class Database {
    ...
    private DatabaseAnnotationWrapper<Order> orderWrapper = null;
    ...
    private Database() {
        ...
        try {
            ...
            orderWrapper = new DatabaseAnnotationWrapper(Order.class, dCH);
        } catch (Exception ex) {
            Logger.getLogger(Database.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public DatabaseAnnotationWrapper<Order> getOrderWrapper() {
        return orderWrapper;
    }
}
